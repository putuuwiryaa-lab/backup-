...
export const typeMeta: Record<string, { accent: string; soft: string; label: string; formula: string }> = {
  ...
  mati: { accent: "#ff647c", soft: "rgba(255, 100, 124, 0.16)", label: "ANGKA MATI", formula: "54 RUMUS" },
  jumlah: { accent: "#b58cff", soft: "rgba(181, 140, 255, 0.16)", label: "JUMLAH MATI", formula: "54 RUMUS" },
