...
function SubMenuCard({ label, meta, onClick }: any) {
  ...
  return (
    <button onClick={onClick} className="premium-card group relative flex min-h-[82px] w-full items-center gap-4 overflow-hidden p-4 text-left transition active:scale-[0.985]" style={{ boxShadow: `0 16px 38px rgba(0,0,0,0.22), 0 0 24px ${meta.glow}` }}>
      ...
      <div className="relative flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl border bg-white/[0.026]" style={{ borderColor: `${meta.accent}66`, color: meta.accent }}>
      ...
      <div className="relative flex h-9 w-9 shrink-0 items-center justify-center rounded-2xl bg-white/[0.045] text-[var(--text-dim)] group-active:text-[var(--gold)]">
