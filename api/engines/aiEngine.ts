...
export const _0x9a025f = [
  ...
  { n: "R26 master moegywara666", f: (c: string, p: string, p2: string) => { const X = +c[2]; const IDX = AI_I[X]; return Array.from(new Set([X, _0xc3c54e(X - 1), IDX, _0xc3c54e(IDX - 1)])); }, dg: 4 },
  { n: "R27 master moegywara666", f: (c: string, p: string, p2: string) => { const A = +c[0]; const K = +c[1]; return Array.from(new Set([_0xJ2d(A, K), _0xc3c54e(A + 1), _0xc3c54e(A + 2), AI_I[A]])); }, dg: 4 },
  { n: "R28 master moegywara666", f: (c: string, p: string, p2: string) => { const X = _0xJ2d(c[2], c[3]); const MB = AI_B[X]; return Array.from(new Set([X, MB, _0xc3c54e(MB + 2)])); }, dg: 3 },
  { n: "R29 master moegywara666", f: (c: string, p: string, p2: string) => { const X = +c[3]; return Array.from(new Set([X, _0xc3c54e(X - 1), _0xc3c54e(X - 2), _0xc3c54e(X + 3), _0xc3c54e(X + 4)])); }, dg: 5 },
